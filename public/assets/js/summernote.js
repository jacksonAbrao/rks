...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
                ...
                var dialog = renderer["a" /* default */].create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
                    ...
                    $node.html(['<div class="modal-dialog  modal-dialog-centered modal-summernote">', '<div class="modal-content">', options.title ? '<div class="modal-header">' + '<p class="modal-title" id="staticBackdropLabel">' + options.title + '</p>' + '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>' + '</div>' : '', '<div class="modal-body">' + options.body + '</div>', options.footer ? '<div class="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
                });
